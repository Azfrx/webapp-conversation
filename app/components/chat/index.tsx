...
const Chat: FC<IChatProps> = ({
  ...
  return (
    <div className={cn(!feedbackDisabled && 'px-3.5', 'h-full')}>
      ...
      {
        !isHideSendInput && (
          <div className='fixed z-10 bottom-0 left-1/2 transform -translate-x-1/2 pc:ml-[122px] tablet:ml-[96px] mobile:ml-0 pc:w-[794px] tablet:w-[794px] max-w-full mobile:w-full px-3.5' style={{ bottom: '40px' }}>
